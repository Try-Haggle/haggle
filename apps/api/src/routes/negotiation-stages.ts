...
const understoodSchema = z.object({
  ...
  information_links: z.array(z.object({
    signal_type: z.string(),
    entity_type: z.string(),
    key: z.string(),
    value: z.string(),
    confidence: z.number(),
    connects_to: z.enum(['pricing', 'product', 'condition', 'terms', 'trust', 'demand', 'outcome', 'memory', 'market']),
  })).optional(),
  missing_information: z.array(z.object({
    ...
    reason: z.string(),
    question: z.string(),
    question_source: z.enum(['tag_garden', 'fallback']).optional(),
    tag_slot_id: z.string().optional(),
