 ...
 * buyer's one chance to spot a deal-breaker before starting. That is also why
 * it is always expanded, never a disclosure: collapsing would hide the safety
 * net behind a click on every listing, to save the height of 1–3 rows.
 *
  ...
  return (
    <section className={className}>
      ...
      <div className="mt-2.5 overflow-hidden rounded-xl border border-line-subtle bg-surface-raised">
        ...
        {/* Precise about the mechanics: the pause fires when a question is left
            unanswered, full stop — not "if it comes up" in conversation. */}
        <p className="border-line-subtle border-t bg-surface-sunken/60 px-3.5 py-2 text-[11px] text-ink-muted leading-relaxed">
          {isOwner
            ...
            : "The seller answered these when listing. Give your agent your answers, or the negotiation pauses once to ask you."}
        </p>
      </div>
    </section>
  );
