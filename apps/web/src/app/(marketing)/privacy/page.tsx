    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-invert prose-slate max-w-none space-y-8 text-ink-secondary leading-relaxed">
        ...
        <section>
          ...
          <h3 className="text-base font-semibold text-ink mb-2">2.1 Information You Provide</h3>
          ...
          <p>
            ...
            your public wallet address. Wallet addresses are public by nature of the blockchain. We
            do not collect private keys, seed phrases, or any information that would grant us access
            to your wallet. Transaction data recorded on the Base blockchain is publicly visible and
            immutable; Haggle has no ability to alter or delete on-chain records.
          </p>

          <h3 className="text-base font-semibold text-ink mt-4 mb-2">
            2.4 Negotiation and Transaction Data
          </h3>
          <p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            ...
            <li>
              To send transactional communications (e.g., offer notifications, dispute updates).
            </li>
          ...
          <p className="mt-3">
            ...
            advertising targeting on third-party platforms.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-base font-semibold text-ink mb-2">4.1 With Other Users</h3>
          <p>
            Certain information is shared with transaction counterparties as necessary to complete a
            deal, including your username or display name and shipping address (shared only after a
            transaction is confirmed).
          </p>

          <h3 className="text-base font-semibold text-ink mt-4 mb-2">4.2 Service Providers</h3>
          ...
          <ul className="list-disc list-inside space-y-2 ml-2 mt-2">
            ...
            <li>
              ...
              inference. Negotiation data sent to AI providers is subject to their data policies. We
              do not send personally identifiable information as part of negotiation prompts where
              avoidable.
            </li>
            <li>
            ...
            <li>
              <strong>Blockchain infrastructure:</strong> Base network RPC providers for transaction
              submission and monitoring.
            </li>
            <li>
              <strong>Analytics:</strong> Anonymized, aggregated usage analytics may be processed by
              analytics platforms.
            </li>
          </ul>

          <h3 className="text-base font-semibold text-ink mt-4 mb-2">4.3 Legal Requirements</h3>
          <p>
          ...
          <h3 className="text-base font-semibold text-ink mt-4 mb-2">4.4 Business Transfers</h3>
          <p>
        ...
        <section>
          ...
          <p>
            We retain account and transaction data for as long as your account is active and for up
            to 7 years thereafter as required for tax, legal, and dispute resolution purposes.
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-2 mt-3">
            ...
            <li>
              <strong>Opt-out of sale (CCPA):</strong> California residents have the right to opt
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">7. Cookies and Tracking</h2>
          ...
          <p className="mt-3">
            ...
            through your browser settings, though disabling essential cookies may impair
            functionality.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">8. Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">10. International Transfers</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">12. Contact Us</h2>
