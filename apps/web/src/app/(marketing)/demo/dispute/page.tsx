...
const views = [
  ...
  },
  {
    ...
    label: "Panel View",
    sub: "Community review",
    description: "Split buyer vs seller positions, decision card with partial refund slider, 9-reviewer voting progress, and settlement preview.",
    icon: "⚖️",
  ...
  },
  {
    ...
    label: "Reviewer View",
    sub: "Individual juror",
    description: "Evidence gallery, 0-100% vote slider, DS profile with tier progression, precedent cases, and post-decision reward view.",
    icon: "👤",
