...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <p className="text-sm text-ink-muted mb-10">Effective Date: April 13, 2026</p>

      <div className="prose prose-invert prose-slate max-w-none space-y-8 text-ink-secondary leading-relaxed">
        <section>
        ...
        <section>
          ...
          <p>
            Haggle is an AI-powered peer-to-peer negotiation and payment protocol. The Service
            enables users to list items for sale, conduct AI-assisted price negotiations, and settle
            transactions using USDC stablecoins on the Base blockchain network. Haggle acts solely
            as a protocol facilitator and does not take custody of user funds at any time.
          </p>
          <p className="mt-3">
            Haggle is not a marketplace, broker, auctioneer, or financial institution. All
            transactions are conducted directly between buyers and sellers via smart contracts.
            Haggle does not guarantee the quality, safety, legality, or availability of any listed
            item.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">3. Eligibility</h2>
          <p>
            You must be at least 18 years of age and have the legal capacity to enter into contracts
            in your jurisdiction to use the Service. By using the Service, you represent and warrant
            that you meet these requirements. You may not use the Service if you are located in a
            jurisdiction where cryptocurrency transactions or peer-to-peer commerce is prohibited.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">4. User Accounts and Obligations</h2>
          <p>You agree to:</p>
          <ul className="list-disc list-inside space-y-2 mt-3 ml-2">
            ...
            <li>
              Accurately describe the condition, provenance, and specifications of listed items.
            </li>
            <li>Complete transactions in good faith once a negotiated price has been accepted.</li>
            <li>
              Comply with all applicable laws, including laws regarding the sale of goods, consumer
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">5. AI Negotiation Agents</h2>
          <p>
            The Service uses AI agents to facilitate price negotiation on behalf of buyers and
            sellers. You acknowledge and agree that:
          </p>
          <ul className="list-disc list-inside space-y-2 mt-3 ml-2">
            <li>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">
            6. Payment Terms and Cryptocurrency
          </h2>
          <p>
            All transactions on the Service are settled in USDC on the Base network via
            non-custodial smart contracts. You acknowledge and agree that:
          </p>
          <ul className="list-disc list-inside space-y-2 mt-3 ml-2">
            <li>
            ...
            <li>
              Blockchain transactions are irreversible once confirmed. Haggle cannot reverse,
              refund, or recover funds lost due to user error, lost private keys, or incorrect
              wallet addresses.
            </li>
            <li>
            ...
            <li>
              You are solely responsible for any tax obligations arising from your use of the
              Service, including capital gains or income taxes related to cryptocurrency
              transactions.
            </li>
            <li>
              Haggle charges a platform fee of 1.5% of the final transaction value, deducted via
              smart contract at settlement. Additional gas fees are paid by users and are not
              controlled by Haggle.
            </li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">7. Shipping and Item Condition</h2>
          <p>
            Sellers are responsible for shipping items as described and in the condition agreed
            upon. Buyers agree to inspect items upon receipt and report discrepancies through the
            Service&apos;s dispute process within the applicable review period. Haggle is not
            responsible for items lost, damaged, or delayed in transit.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">8. Dispute Resolution</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">9. Intellectual Property</h2>
          <p>
            ...
            reverse-engineer, or create derivative works from the Service without prior written
            consent.
          </p>
          <p className="mt-3">
            The Haggle Negotiation Protocol (HNP) specification is published openly. Nothing in
            these Terms restricts your use of the published specification for building compatible
            implementations.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            HAGGLE&apos;S TOTAL LIABILITY FOR ANY CLAIM ARISING FROM OR RELATED TO THESE TERMS OR
            THE SERVICE SHALL NOT EXCEED THE GREATER OF (A) THE TOTAL PLATFORM FEES PAID BY YOU IN
            THE THREE MONTHS PRECEDING THE CLAIM, OR (B) ONE HUNDRED DOLLARS (USD $100).
          </p>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">12. Prohibited Uses</h2>
          <p>You may not use the Service to:</p>
          <ul className="list-disc list-inside space-y-2 mt-3 ml-2">
            <li>Facilitate money laundering, fraud, or other illegal financial activities.</li>
            <li>
              Sell items that are illegal, counterfeit, stolen, or subject to export controls.
            </li>
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">14. Changes to Terms</h2>
          <p>
            Haggle reserves the right to modify these Terms at any time. We will provide notice of
            material changes by updating the effective date above and, where practicable, by
            notifying you via email or in-app notice. Your continued use of the Service after
