  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-10 max-md:px-6">
        <div
          className="relative overflow-hidden rounded-4xl px-14 pt-21 pb-22 text-center text-white shadow-[0_24px_60px_rgba(27,42,74,0.22)] max-lg:rounded-3xl max-lg:px-7 max-lg:pt-14 max-lg:pb-16"
          style={{
            background: `
