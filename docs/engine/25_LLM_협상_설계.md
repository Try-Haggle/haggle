...
판매자/구매자가 설정하는 급함 정도. 두 곳에 영향:

**시간 효용 (v_t)**: urgency가 높을수록 유효 데드라인 단축 → v_t 가파르게 하락

| urgency | alpha 증폭 | 유효 시간 (7일 기준) |
|---------|-----------|-------------------|
| low | ×0.8 | 8.75일 (더 느긋) |
| normal | ×1.0 | 7일 |
| high | ×1.5 | 4.67일 |
...
**Faratin 양보곡선**: urgency가 높을수록 beta 감소 → 양보 속도 증가
